...
public class EagerInitHandler implements RequestHandler<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    ...
    private final ProductStoreImpl productStore = new ProductStoreImpl(productMapper, dynamoDbClient, s3Client);
